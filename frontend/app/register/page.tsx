    ...
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4">
      <div className="bg-surface border border-border rounded-2xl p-8 w-full max-w-md space-y-6 shadow-2xl">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-400">Get started with Traders World AI Operating System</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4 text-xs">
          <div>
            <label className="text-gray-400 block mb-1 font-mono">FULL NAME</label>
            <input
              type="text"
              required
              placeholder="Shubham Hulsure"
              value={name}
        ...
        <div className="text-center text-xs text-gray-400 pt-2 border-t border-border">
          ...
          <Link href="/login" className="text-accent underline font-semibold">
            Sign In
          </Link>
        </div>
      </div>
